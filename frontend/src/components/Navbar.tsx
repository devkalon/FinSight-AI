        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
          <div className="bg-[#0F172A] border border-[#1E293B] rounded-2xl max-w-md w-full p-6 shadow-2xl relative">
            ...
            <p className="text-xs text-slate-400 mb-5">
              Choose an account or enter your Google credentials to continue to <span className="text-white font-medium">FinSight AI</span>.
            </p>
            ...
            <form onSubmit={handleCustomGoogleSubmit} className="space-y-4">
              <div>
                <label className="block text-xs font-semibold text-slate-300 mb-1">Google Account Name</label>
                <input
                  type="text"
                  value={customGoogleName}
                  onChange={(e) => setCustomGoogleName(e.target.value)}
                  placeholder="e.g. Alex Morgan"
                  className="w-full px-3.5 py-2.5 rounded-lg bg-[#272F42] border border-[#1E293B] text-slate-100 text-sm focus:outline-none focus:border-amber-500"
                />
              </div>
              ...
              <div className="p-3 rounded-lg bg-[#272F42]/60 border border-[#1E293B] text-[11px] text-slate-400 space-y-1">
                <p className="font-semibold text-slate-300">🔐 OAuth 2.0 Security Scope</p>
                <p>FinSight AI will receive your name, email address, and language preference. No financial credentials are shared with Google.</p>
              </div>
              ...
              <div className="flex gap-2 pt-2">
                <button
                  ...
                  className="flex-1 py-2.5 rounded-lg bg-[#272F42] hover:bg-[#1E293B] text-slate-300 text-xs font-semibold"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="flex-1 py-2.5 rounded-lg bg-amber-500 hover:bg-amber-400 text-[#0F172A] text-xs font-semibold shadow-md shadow-amber-500/20 disabled:opacity-50 flex items-center justify-center space-x-2"
                >
